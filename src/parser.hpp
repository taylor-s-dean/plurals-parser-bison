  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_unit = 19,                             // unit
        S_if_statement = 20,                     // if_statement
        S_multiplicative = 21,                   // multiplicative
        S_associative = 22,                      // associative
        S_relational = 23,                       // relational
        S_equality = 24,                         // equality
        S_logical = 25,                          // logical
